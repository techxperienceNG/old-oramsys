...
const IndividualAddress = ({
  ...
  useEffect(() => {
    if (entityGetById && entityGetById.data && entityGetById.status === 200) {
      let tempResidential = entityGetById.data.addresses.find(
      ...
      let tempProfessional = entityGetById.data.addresses.find(
        (item1) => item1.type === "Professional"
      )
  ...
  const handleResidentialChange = (event) => {
    if (
      ...
      event.target.name === "addressLine1" ||
      event.target.name === "addressLine2" ||
      event.target.name === "addressLine3" ||
            ...
            <Row>
              <Col lg={3}>
                <TextField
                  ...
                  disabled={isView}
                />
                {formErrors && formErrors?.Residential?.flatNumber && (
                  <span style={{ color: "red" }}>
                    {formErrors.Residential.flatNumber}
                  </span>
                )}
              </Col>
              <Col lg={3}>
                <TextField
                  ...
                  disabled={isView}
                />
                {formErrors && formErrors?.Residential?.addressLine1 && (
                  <span style={{ color: "red" }}>
                    {formErrors.Residential.addressLine1}
                  </span>
                )}
              </Col>
              <Col lg={3}>
                <TextField
                  ...
                  disabled={isView}
                />
                {formErrors && formErrors?.Residential?.addressLine2 && (
                  <span style={{ color: "red" }}>
                    {formErrors.Residential.addressLine2}
                  </span>
                )}
              </Col>
              <Col lg={3}>
                <TextField
                  ...
                  disabled={isView}
                />
                {formErrors && formErrors?.Residential?.addressLine3 && (
                  <span style={{ color: "red" }}>
                    {formErrors.Residential.addressLine3}
                  </span>
                )}
              </Col>
            </Row>
            <Row className='mt-4'>
              <Col lg={3}>
                <TextField
                  ...
                  disabled={isView}
                />
                {formErrors && formErrors?.Residential?.postcode && (
                  <span style={{ color: "red" }}>
                    {formErrors.Residential.postcode}
                  </span>
                )}
              </Col>
              <Col lg={3}>
                <TextField
                  ...
                  disabled={isView}
                />
                {formErrors && formErrors?.Residential?.state && (
                  <span style={{ color: "red" }}>
                    {formErrors.Residential.state}
                  </span>
                )}
              </Col>
              <Col lg={3}>
                <TextField
                  ...
                  disabled={isView}
                />
                {formErrors && formErrors?.Residential?.city && (
                  <span style={{ color: "red" }}>
                    {formErrors.Residential.city}
                  </span>
                )}
              </Col>
              ...
              <Col lg={3}>
                <Autocomplete
                  ...
                  disableClearable
                  value={
                    countryData.length && ResidentialState?.country
                      ? countryData.find(
                          (item) => item._id === ResidentialState.country
                        )
                      : {}
                  }
                />
                {formErrors && formErrors?.Residential?.country && (
                  <span style={{ color: "red" }}>
                    {formErrors.Residential.country}
                  </span>
                )}
              </Col>
            </Row>
            ...
            <Row className='mt-4'>
              <Col lg={3}>
                <TextField
                  ...
                  disabled={isView}
                />
                {formErrors && formErrors?.Residential?.mobile && (
                  <span style={{ color: "red" }}>
                    {formErrors.Residential.mobile}
                  </span>
                )}
              </Col>
              <Col lg={3}>
                <TextField
                  ...
                  disabled={isView}
                />
                {formErrors && formErrors?.Residential?.telephone && (
                  <span style={{ color: "red" }}>
                    {formErrors.Residential.telephone}
                  </span>
                )}
              </Col>
              <Col lg={3}>
                <TextField
                  ...
                  disabled={isView}
                />
                {formErrors && formErrors?.Residential?.fax && (
                  <span style={{ color: "red" }}>
                    {formErrors.Residential.fax}
                  </span>
                )}
              </Col>
              <Col lg={3}>
                <TextField
                  ...
                  disabled={isView}
                />
                {formErrors && formErrors?.Residential?.email && (
                  <span style={{ color: "red" }}>
                    {formErrors.Residential.email}
                  </span>
                )}
              </Col>
            </Row>
            ...
            <Row>
              <Col lg={3}>
                <TextField
                  ...
                  disabled={isView}
                />
                {formErrors && formErrors?.Professional?.flatNumber && (
                  <span style={{ color: "red" }}>
                    {formErrors.Professional.flatNumber}
                  </span>
                )}
              </Col>
              <Col lg={3}>
                <TextField
                  ...
                  disabled={isView}
                />
                {formErrors && formErrors?.Professional?.addressLine1 && (
                  <span style={{ color: "red" }}>
                    {formErrors.Professional.addressLine1}
                  </span>
                )}
              </Col>
              <Col lg={3}>
                <TextField
                  ...
                  disabled={isView}
                />
                {formErrors && formErrors?.Professional?.addressLine2 && (
                  <span style={{ color: "red" }}>
                    {formErrors.Professional.addressLine2}
                  </span>
                )}
              </Col>
              <Col lg={3}>
                <TextField
                  ...
                  disabled={isView}
                />
                {formErrors && formErrors?.Professional?.addressLine3 && (
                  <span style={{ color: "red" }}>
                    {formErrors.Professional.addressLine3}
                  </span>
                )}
              </Col>
            </Row>
            <Row className='mt-4'>
              <Col lg={3}>
                <TextField
                  ...
                  disabled={isView}
                />
                {formErrors && formErrors?.Professional?.postcode && (
                  <span style={{ color: "red" }}>
                    {formErrors.Professional.postcode}
                  </span>
                )}
              </Col>
              <Col lg={3}>
                <TextField
                  ...
                  disabled={isView}
                />
                {formErrors && formErrors?.Professional?.state && (
                  <span style={{ color: "red" }}>
                    {formErrors.Professional.state}
                  </span>
                )}
              </Col>
              <Col lg={3}>
                <TextField
                  ...
                  disabled={isView}
                />
                {formErrors && formErrors?.Professional?.city && (
                  <span style={{ color: "red" }}>
                    {formErrors.Professional.city}
                  </span>
                )}
              </Col>
              ...
              <Col lg={3}>
                <Autocomplete
                  ...
                  disableClearable
                  value={
                    countryData.length && ProfessionalState?.country
                      ? countryData.find(
                          (item) => item._id === ProfessionalState.country
                        )
                      : {}
                  }
                />
                {formErrors && formErrors?.Professional?.country && (
                  <span style={{ color: "red" }}>
                    {formErrors.Professional.country}
                  </span>
                )}
              </Col>
            </Row>
            ...
            <Row className='mt-4'>
              <Col lg={3}>
                <TextField
                  ...
                  disabled={isView}
                />
                {formErrors && formErrors?.Professional?.mobile && (
                  <span style={{ color: "red" }}>
                    {formErrors.Professional.mobile}
                  </span>
                )}
              </Col>
              <Col lg={3}>
                <TextField
                  ...
                  disabled={isView}
                />
                {formErrors && formErrors?.Professional?.telephone && (
                  <span style={{ color: "red" }}>
                    {formErrors.Professional.telephone}
                  </span>
                )}
              </Col>
              <Col lg={3}>
                <TextField
                  ...
                  disabled={isView}
                />
                {formErrors && formErrors?.Professional?.fax && (
                  <span style={{ color: "red" }}>
                    {formErrors.Professional.fax}
                  </span>
                )}
              </Col>
              <Col lg={3}>
                <TextField
                  ...
                  disabled={isView}
                />
                {formErrors && formErrors?.Professional?.email && (
                  <span style={{ color: "red" }}>
                    {formErrors.Professional.email}
                  </span>
                )}
              </Col>
            </Row>
