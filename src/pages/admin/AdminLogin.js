...
const AdminLogin = () => {
  ...
  const Login = (e) => {
    ...
    ApiPostNoAuth("superAdmin/login", data)
      .then((res) => {
        dispatch({
          type: LOGIN,
      ...
      <div className='container'>
        <div className='sign-grd'>
          ...
          <div className='rgt-pan'>
            <p>
              This is the administrative portal, if you are not an administrator
              you cannot have access. Please go to the client login
            </p>
